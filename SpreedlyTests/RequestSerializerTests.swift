...
class RequestSerializerTests: XCTestCase {
    ...
    func testSerializesApplePayPaymentData() {
        let expectation = "{ \"payment_method\": { \"apple_pay\": { \"payment_data\": \(paymentDataString!) }}}".dataUsingEncoding(NSUTF8StringEncoding)
        let serializedRequest = RequestSerializer.serialize(paymentDataString!.dataUsingEncoding(NSUTF8StringEncoding)!)
